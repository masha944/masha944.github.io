    ...
    <li><a href="../o_nas/ustav.php">Устав</a></li>
          ...
          <div id="news_txt" >
            ...
            <tr>
                <th>
                <div>
 				  <img src = '../images/rukovodstvo/127600660703596000.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);' class="rightimg"/>
				</div>
                </th>
                <th>
                <div>
 				  <img src = '../images/rukovodstvo/127600658312454200.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);'class="rightimg" />
				</div>

                </th>
                <th>
                  <img src = '../images/rukovodstvo/127600656245219700.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);' class="rightimg"/>
                </th>
            </tr>
            <tr>
                <th>
                <img src = '../images/rukovodstvo/127600654794380500.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);' class="rightimg"/>

                </th>
                <th>
                <img src = '../images/rukovodstvo/127624177686508000.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);' class="rightimg" />

                </th>
                <th>
                <img src = '../images/rukovodstvo/127624149841035500.jpg' alt = 'Фотография' width = '230' height="180" onclick = 'openImageWindow(this.src);' class="rightimg" />
