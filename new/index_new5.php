  ...
  <div id="one">
    ...
    <li><a href="../kontakt.php">Контакты</a></li>
     ...
     <div id="main">  	
         <div id="scrollbar1"> 
         <div id="in">
         <h2 style="color:#FFF">В Брянске начали обновлять освещение на улицах города. </h2>
         </div> 
         
         <br>
          <img style="margin-right: 15px; margin-top: 10px" id="rukovod" src="../images/new/H8xJLV4Eylc.jpg"  width="280" height="200" class="leftimg">
          
           <p id="p" id="new" align="left" style="position:relative; font-size:22px; line-height:1.5;font-family: 'Helvetica Neue';" >В рамках национального проекта "Безопасные и качественные автомобильные дороги" в Брянске производят демонтаж старого освещения и устанавливают новые светодиодные лампы. Работы начались на проспекте Ленина и улице Дуки и осуществляются на других улицах города. 
</p>
           <img style="margin-right:15px; margin-top: 10px" id="rukovod" src="../images/new/IdRObW_K2bw.jpg" width="280" height="200" class="rightimg ">
          <p id="p" align="left" style="position:relative; font-size:22px; line-height:1.5; font-family: 'Helvetica Neue';">Сегодня мы с вами можем увидеть новую дорожную разметку на улице Дуки. Напомним, протяженность этого участка составляет 2,294 км.
Так же центральный перекрёсток города на пересечении проспекта Ленина и улицы Фокина приобрёл новую разметку для пешеходов. 
Дорожные работы на данных участках приближаются к завершению.</p>
