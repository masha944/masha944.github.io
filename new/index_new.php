  ...
  <div id="one">
    ...
    <li><a href="../kontakt.php">Контакты</a></li>
     ...
     <div id="main">  	
         ...
         <br>
          <img style="margin-right: 15px; margin-top: 10px" id="rukovod" src="../images/new/cVIIgkIw6PE.jpg"  width="280" height="200" class="leftimg">
          
           <p id="p" id="new" align="left" style="position:relative; font-size:22px; line-height:1.5;font-family: 'Helvetica Neue';" >В Брянске продолжается реализация национального проекта «Безопасные и качественные автомобильные дороги». </p>
          <p id="p" align="left" style="position:relative; font-size:22px; line-height:1.5; font-family: 'Helvetica Neue';">В его рамках будут отремонтированы 24 городские автодороги, из них 12 — в Советском районе областного центра. Большая часть работы на многих улицах Брянска уже сделана. Сейчас полным ходом идет капитальный ремонт автодороги по улице Спартаковской (от проспекта Станке-Димитрова до улицы Урицкого). 
         <img style="margin-right:15px; margin-top: 10px" id="rukovod" src="../images/new/bBBBVBW4Dd4.jpg" width="280" height="200" class="rightimg ">
          <p id="p" align="left" style="position:relative; font-size:22px; line-height:1.5; font-family: 'Helvetica Neue';">Рабочие подрядной организации – ООО «Дорстрой 32» - приступили к укладке первого выравнивающего слоя асфальта. Полностью работы планируется завершить в третьем квартале 2019 года. </p>
</p>
