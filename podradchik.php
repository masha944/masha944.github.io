  ...
  <div id="one">
   ...
   <div id="container"> 
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">Подрядчики</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                    ...
                    <a href="podradchik/nedobr.php"> <u><h3 align="left" id="p">Недобросовестные подрядчики</h3></u></a>
                    <div id="line"></div>
                    <a href="podradchik/avtobanstroi.php"> <u><h3 align="left" id="p">ООО "АВТОБАНСТРОЙ"</h3></u></a>
                    <a href="podradchik/ani.php"> <u><h3 align="left" id="p">ООО "АНИ"</h3></u></a>
					<p align="left" id="p">Строительство, ремонт автомобильных дорог.</p>
                    <a href="podradchik/branskavtodor.php"> <u><h3 align="left" id="p">АО «БРЯНСКАВТОДОР»</h3></u></a>
					<p align="left" id="p">Основной вид выполняемых работ: содержание, ремонт строительство автомобильных дорог и элементов обустройства</p>
                    <a href="podradchik/branskagr.php"> <u><h3 align="left" id="p">ООО «БРЯНСКАГРОПРОМДОРСТРОЙ»</h3></u></a>
					<p align="left" id="p">Основной вид выполняемых работ: строительство, ремонт, содержание автомобильных дорог.</p>
                    <a href="podradchik/avtomost.php"> <u><h3 align="left" id="p">НАО БМФ «Автомост»</h3></u></a>
					<p align="left" id="p">Основной вид выполняемых работ: Строительство, ремонт, содержание мостов.</p>
                    <a href="podradchik/rds.php"> <u><h3 align="left" id="p">ООО «РДС – Брянск»</h3></u></a>
					<p align="left" id="p">Основной вид выполняемых работ: Работы по нанесению разметки и установке знаков с изготовлением.</p>
                    <a href="podradchik/dorojnik.php"> <u><h3 align="left" id="p">ОАО «Дорожник»</h3></u></a>
					<p align="left" id="p">Основной вид выполняемых работ: Ремонт, содержание автомобильных дорог.</p>
