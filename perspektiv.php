  ...
  <div id="one">
    ...
    <li><a href="kontakt.php">Контакты</a></li>
     ...
     <div id="main">  	
         ...
         <div id="in">
         <h2 style="color:#FFF">Перспективы и задачи</h2>
         </div> 
         
         <br>
         <b><p style="color:#000" id="zag1" align="left" style="text-indent: 25px;">Текущее программное планирование.</p> </b>
         <p style="color:#000" id="zag1" align="left" style="text-indent: 25px;">В настоящее время основные мероприятия дорожной деятельности выполняются в рамках подпрограммы «Автомобильные дороги» государственной программы «Обеспечение реализации государственных полномочий в области строительства, архитектуры и развитие дорожного хозяйства Брянской области - <a style="color:#000" target="_blank" href="fail/731-p.pdf"> <u>просмотреть</a></u></p> 
