  ...
  <div id="one">
    ...
    <div id="container">   		   	
     ...
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">Торги</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                 
                 
                 <p align="left" id="p">Проведение конкурсных процедур в отношении объектов дорожной деятельности осуществляется в соответствии с планом-графиком закупок:</p>
                 <a id="p" target="_blank" href="http://zakupki.gov.ru/epz/order/quicksearch/search.html?searchString=3234046165"> <u><h3 align="left" id="p">zakupki.gov.ru</h3></u></a>
