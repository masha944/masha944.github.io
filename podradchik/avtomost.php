  ...
  <div id="one">
   ...
   <div id="container"> 
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">НАО БМФ «Автомост»</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                     ...
                     <p align="left" id="p">Генеральный директор Лаптев Александр Викторович</p>
                     
                     <p align="left"  id="p">Юридический адрес: 241050, г. Брянск, ул. Трудовая, д. 5</p>
					<p align="left"  id="p">т. 8 (4832) 74-22-19</p>
                    
                     <p align="left"  id="p">Основной вид выполняемых работ: строительство, ремонт, содержание мостов.</p>
                     <p align="left"  id="p">Средний годовой объем выполненных дорожных работ на территории Брянской области за прошедший период – 32,4 млн.рублей, в том числе</p>
                     <p align="left"  id="p">строительство- 7,2</p>
                     <p align="left"  id="p">ремонт – 0,4</p>
                     <p align="left"  id="p">содержание – 24,8</p>
