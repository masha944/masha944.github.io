  ...
  <div id="one">
   ...
   <div id="container">
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">ООО «РДС – Брянск»</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                     ...
                     <p align="left" id="p">Генеральный директор Фролов Юрий Иванович</p>
                     
                     <p align="left" id="p">Юридический адрес: г.Брянск, пр-т Станке Димитрова, д. 45</p>
					<p align="left" id="p">т. 8 (4832) 41-73-10</p>
                    
                     <p align="left" id="p">Основной вид выполняемых работ: работы по нанесению разметки и установке знаков с изготовлением.</p>
                     <p align="left" id="p">Средний годовой объем выполненных дорожных работ на территории Брянской области за прошедший период – 11,5 млн.рублей.</p>
