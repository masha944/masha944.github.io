  ...
  <div id="one">
    ...
    <li><a href="../kontakt.php">Контакты</a></li>
     ...
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">ОАО «Дорожник»</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                     ...
                     <p align="left" id="p">Генеральный директор Билько Евгений Иванович</p>
                     
                     <p align="left" id="p">Юридический адрес: г. Стародуб, ул. Советская, д. 15</p>
					<p align="left" id="p">т. 8 (48348) 2-22-68</p>
                    
                     <p align="left" id="p">Основной вид выполняемых работ: Ремонт, содержание автомобильных дорог.</p>
                     <p align="left" id="p">Средний годовой объем выполненных дорожных работ на территории Брянской области за прошедший период – 11,8 млн.рублей.</p>
