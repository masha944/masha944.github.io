  ...
  <div id="one">
    ...
    <li><a href="../kontakt.php">Контакты</a></li>
     ...
     <div id="main">  	
         ...
         <div id="in_new">
         <h2 style="color:#FFF">ООО «БРЯНСКАГРОПРОМДОРСТРОЙ»</h2>
         </div> 
          <div id="scrollbar1"> 
          <div id="news_txt" >
                     ...
                     <p align="left" id="p">Генеральный директор - Филимонов Дмитрий Владимирович</p>
                     
                     <p align="left" id="p">Юридический адрес: 241035, РФ, Брянская область, г. Брянск, ул. 50-й Армии, д. 3а</p>
					<p align="left" id="p">т. 8 (4832) 74-64-20</p>
                    <p align="left" id="p">ф. 8 (4832) 74-68-27</p>
                    
                     <p align="left" id="p">Основной вид выполняемых работ: строительство, ремонт, содержание автомобильных дорог.</p>
                     <p align="left" id="p">Средний годовой объем выполненных дорожных работ на территории Брянской области за прошедший период – 448,3 млн.рублей, в том числе</p>
                     <p align="left" id="p">строительство- 292,6</p>
                     <p align="left" id="p">ремонт – 86,5</p>
                     <p align="left" id="p">содержание – 69,3</p>
